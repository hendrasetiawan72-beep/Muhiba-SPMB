  ...
  return (
    <div className="min-h-screen bg-slate-100 py-6 sm:py-10 px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        {/* ========================================================================= */}
        {/* TABBED INFORMATION BOX (Screenshot 4, 5, 6) */}
        {/* ========================================================================= */}
        <div className="bg-white rounded-xl shadow-sm border border-slate-200/80 p-6">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
            ...
            {/* Right Tab Content */}
            <div className="md:col-span-8 bg-slate-50/50 p-6 rounded-xl border border-slate-100 min-h-[220px]">
              
              {/* TAB 1: INFORMASI PENDAFTARAN (Screenshot 4) */}
              {activeTab === 'info' && (
                <div className="space-y-6 text-sm text-slate-700">
                  <div className="space-y-2">
                    ...
                    <button
                      ...
                      className="px-4 py-2 text-xs font-bold text-white bg-red-500 hover:bg-red-600 rounded-md transition-colors flex items-center gap-1.5"
                    >
                  ...
                  <div className="space-y-2">
                    <p className="font-semibold text-slate-800">
                      2. Login menggunakan akun yang dibuat saat pendaftaran.
                    </p>
                    <button
                      onClick={onNavigateLogin}
                      className="px-4 py-2 text-xs font-bold text-white bg-emerald-500 hover:bg-emerald-600 rounded-md transition-colors flex items-center gap-1.5"
                    >
                  ...
                  <div>
                    <p className="font-semibold text-slate-800">
                      3. Lengkapi seluruh formulir dengan data yang benar.
                    </p>
                  </div>
                </div>
              )}

              {/* TAB 2: SYARAT PENDAFTARAN (Screenshot 5) */}
              {activeTab === 'syarat' && (
                <div className="space-y-3 text-xs font-medium text-slate-700">
                  <h4 className="font-bold text-sm text-slate-900 mb-3">SYARAT PENDAFTARAN:</h4>
                  <ol className="space-y-2 list-decimal list-inside leading-relaxed text-slate-800">
                    <li>SURAT KETERANGAN LULUS (SKL) ASLI</li>
                    <li>FOTOCOPY IJAZAH SMP / MTS / PAKET B (Bagi yang sudah keluar) atau FC. IJASAH SD/MI (Bagi yang belum keluar)</li>
                    <li>FOTOCOPY AKTA KELAHIRAN</li>
                    <li>FOTOCOPY KARTU KELUARGA</li>
                    <li>FOTOCOPY KTP ORANG TUA (AYAH & IBU)</li>
                    <li>PAS FOTO UKURAN 3X4 SEJUMLAH 5 LEMBAR</li>
                    <li>FOTOCOPY KIP/PKH/KKS/SKTM (Bagi pemegang kartu bantuan)</li>
                    <li>FOTOCOPY PIAGAM PENGHARGAAN (JALUR PRESTASI)</li>
                  </ol>
                </div>
              )}

              {/* TAB 3: KONTAK PENDAFTARAN (Screenshot 6) */}
              {activeTab === 'kontak' && (
                <div className="space-y-4">
                  <h4 className="font-bold text-sm text-slate-900 mb-2">PANITIA PPDB SMK MUHIBA:</h4>
                  ...
                  <div className="flex items-center gap-4 bg-white p-3 rounded-lg border border-slate-200">
                    ...
                    <div className="flex-1">
                      ...
                      <a
                        ...
                        className="inline-flex items-center gap-1.5 mt-1 px-3 py-1 bg-emerald-500 hover:bg-emerald-600 text-white rounded text-xs font-bold transition-colors"
                      >
